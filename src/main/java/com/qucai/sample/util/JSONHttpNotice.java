...
public class JSONHttpNotice {
	...
	public JSONHttpNotice(String masterURL) throws URIException {
		this(masterURL, null);
	}

	public JSONHttpNotice(String masterURL, String slaveURL) throws URIException {
