...
public class AmtQueryServlet extends HttpServlet {

	private static final long serialVersionUID = 2809334177724187609L;

	public AmtQueryServlet() {
		super();
	}
	public void destroy() {
		super.destroy(); 
	...
	public void doPost(String merchantId,HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		merchantId = request.getParameter("merchantId"); // 商户号
