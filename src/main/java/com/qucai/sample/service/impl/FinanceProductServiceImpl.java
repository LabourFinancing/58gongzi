...
*/
   ...
   public int deleteByPrimaryKey(String t_FProd_ID) {
    ...
    @Override
    public List<FinanceProduct> findSearchList(Map<String, Object> paramSearchMap) {
        return financeProductDao.findSearchList(paramSearchMap);
    }
    
    @Override
    public PageInfo<FinanceProduct> findAllList(Map<String, Object> paramMap, PageParam pp) {
        PageHelper.startPage(pp.getPageNum(), pp.getPageSize(), true, true);
        List<FinanceProduct> list = financeProductDao.findAllList(paramMap);
        return new PageInfo<FinanceProduct>(list);
    }
    
    @Override
    public PageInfo<FinanceProduct> findSearchList(PageParam pp, Map<String, Object>paramSearchMap) {
        PageHelper.startPage(pp.getPageNum(), pp.getPageSize(), true, true);
        List<FinanceProduct> list = financeProductDao.findSearchList(paramSearchMap);
        return new PageInfo<FinanceProduct>(list);
    }
