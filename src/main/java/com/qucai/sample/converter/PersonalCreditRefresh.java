...
//
//import com.qucai.sample.smss.src.com.dahantc.api.commons.EncryptUtil;
//import com.qucai.sample.smss.src.com.dahantc.api.commons.MySecureProtocolSocketFactory;
//
//public class PersonalCreditRefresh {
...
//
//	public PersonalCreditRefresh(String masterURL) throws URIException {
//		this(masterURL, null);
//	}
//
//	public PersonalCreditRefresh(String masterURL, String slaveURL) throws URIException {
...
//	 * @param string 
//	 */
//	public String sendSms(String clientid, String password, String mobile,String smstype, String content,Date sendtime, String extend, String uid) {
...
////	}
//
////	public String sendSms(String clientid, String password, String mobile, String content, String uid, String smstype, String extend, Date sendtime) {
////		return sendSms(clientid, password, mobile, content, uid, smstype, extend, sendtime);
////	}
//
////	public String sendSms(String clientid, String password, String smstype, String mobile, String content, Date sendtime,String extend,String uid) {
////		return sendSms(clientid, password, smstype, mobile, content, sendtime, extend,uid);
////	}
//
//	/**
//	 * 获取状态报告
