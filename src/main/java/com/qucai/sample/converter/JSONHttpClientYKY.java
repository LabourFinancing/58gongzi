...
public class JSONHttpClientYKY {
	...
	public JSONHttpClientYKY(String masterURL) throws URIException {
		this(masterURL, null);
	}

	public JSONHttpClientYKY(String masterURL, String slaveURL) throws URIException {
