...
public class HttpRequestUtil extends com.qucai.sample.sandfastpay.main.java.cn.com.sand.pay.online.sdk.http.SSLClient {
	...
	public static String uploadFile(String url, File file) throws Exception {
		...
		if ("https".equalsIgnoreCase(urlObj.getProtocol())) {
			cn.com.sand.pay.online.sdk.http.SslUtils.ignoreSsl();
		}
