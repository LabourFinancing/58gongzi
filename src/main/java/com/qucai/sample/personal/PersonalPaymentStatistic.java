...
@Controller
public class PersonalPaymentStatistic {
...
//    3rd party payment call coding...
    ...
    //Transit total charge fee calc
    public static Object paymentServiceFeeCalc(MobileEwalletDashboard mobileEwalletDashboard){
        System.out.println();
