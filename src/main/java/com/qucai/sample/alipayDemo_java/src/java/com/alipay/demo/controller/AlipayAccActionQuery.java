...
public class AlipayAccActionQuery {


    public static Map<String, Object> alipayTxnList(MobileEwalletDashboard mobileEwalletDashboard) throws AlipayApiException {
...
//            "\"page_size\":\"2000\"" +
//            "  }");
//        AlipayDataBillTransferQueryResponse response = alipayClient.execute(request);
