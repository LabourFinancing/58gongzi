...
/* biz info char */
   ...
   private String t_personalewallet_ClearNum;
   ...
   private String t_personalewallet_TotFXBalance;
   
   private String t_personalewallet_TotCryptoBalance;
   ...
   private Integer t_personalewallet_PayCounts;
    ...
    public String getT_personalewallet_ClearNum() {
        return t_personalewallet_ClearNum;
    }

    public void setT_personalewallet_ClearNum(String t_personalewallet_ClearNum) {
    ...
    public String getT_personalewallet_TotFXBalance() {
        return t_personalewallet_TotFXBalance;
    }

    public void setT_personalewallet_TotFXBalance(String t_personalewallet_TotFXBalance) {
        this.t_personalewallet_TotFXBalance = t_personalewallet_TotFXBalance;
    }

    public String getT_personalewallet_TotCryptoBalance() {
        return t_personalewallet_TotCryptoBalance;
    }

    public void setT_personalewallet_TotCryptoBalance(String t_personalewallet_TotCryptoBalance) {
