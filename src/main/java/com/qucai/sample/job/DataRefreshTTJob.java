...
*/
    ...
    public void EwalletStaticDataRefresh() throws Exception {
        ...
        String sql = "UPDATE t_personal_ewallet, (select t_treasurydb_main.t_TreasuryDB_Main_BaselineValue as personalDays,t_treasurydb_main.t_TreasuryDB_Main_BaselineValue as baseValue from t_treasurydb_main) as a "
	...
	public void PaymentChkCreditRT() throws Exception {
	    ...
	    for(int i=0;i<StaffPrepayApplicationPayment.size();i++){
	        ...
	        if (PaymentVendor.equals("sandpay")) {
                ...
                String[] staffPrepayApplicationPayment = StaffPrepayApplicationPayment.toArray(new String[StaffPrepayApplicationPayment.size()]);
		    	RC = OrderQueryDemo.main(staffPrepayApplicationPayment,merchantId);
